...
class GlucosePageState extends State<GlucosePage> {
  ...
  final TextEditingController _glucosePercentageController =
    ...
    if (_formKey.currentState?.validate() ?? false) {
      ...
      if (_showEnteralFields) {
        ...
        if (_showCustomMilkCarbsField) {
          milkCarbohydratePercentage =
              double.tryParse(_milkStrengthController.text);
          if (milkCarbohydratePercentage == null) {
            throw Exception(
                "The carb concentration of the milk cannot be null.");
          }
          enteralGIR = calculateGlucoseInfusionRate(
              milkCarbohydratePercentage, milkInfusionRate, weight);
        } else {
              ...
              content: Column(
                children: [
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              if (enteralGIR > 0)
                                Text(
                                    "${enteralGIR.toStringAsFixed(1)} mg/kg/min"),
                              if (parenteralGIR > 0)
                                Text(
                                    "${parenteralGIR.toStringAsFixed(1)} mg/kg/min"),
                            ],
                          ),
                        ],
                      ),
                  ...
                  if (milkInfusionRate > 0) ...[
                    Padding(
                      padding: const EdgeInsets.only(
                          top: 16.0), // Adjust padding value as needed
                      child: Text(
                        ...
                        for (int i = 1; i <= 4; i++)
                          Row(
                            ...
                            children: [
                              Text("$i-hourly feeds:"),
                              Text(
                                  "${(milkInfusionRate * i).toStringAsFixed(0)} ml/feed"),
                            ],
                          ),
                      ],
                    )
                  ...
                  children: [
                          ...
                          const Expanded(
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Tooltip(
                                    message:
                                        'If the child or young person is on feeds, include this here. Common and specialist milks are ',
                          ...
                          child: Column(
                            children: [
                                        ...
                                        items: _dropdownItems.map((Milk item) {
                                          return DropdownMenuItem<Milk>(
                                              ...
                                              child: SizedBox(
                                                width: 300,
                                                child: Text(
                                                    "${item.name} (${item.carbsPer100ml}g)"),
                                              ));
                                        }).toList(),
                              ...
                              TextFormField(
                                ...
                                validator: (value) {
                                  if (value == null ||
                                      value.isEmpty && _showEnteralFields) {
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed:
                            (!_showEnteralFields && !_showParenteralFields)
                                ? null
                                : _submitForm,
