  ...
  void _submitForm() {
    ...
    if (_isTbwKnown) {
      ...
      if (totalBodyWaterValue <= 0) {
        _showErrorDialog("Calculation Error",
            "Calculated Total Body Water is invalid. Please check inputs.");
        return;
      }
    }
  ...
  void _resetForm() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _formKey.currentState
          ?.validate(); // Clear validation messages from now-empty fields
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              child: Icon(
                                Icons.close,
                                color:
                                    Colors.grey[700], // Choose a suitable color
                                size: 20,
                              ),
                            ),
                          ),
                    ...
                    items: _salines.map((Saline saline) {
                      return DropdownMenuItem<Saline>(
                          ...
                          child: SizedBox(
                            width: 300,
                            child: Text(
                                "${saline.name} (${saline.mmolperlitre} mmol/L)"),
                          ));
                    }).toList(),
                ...
                SwitchListTile(
                  ...
                  onChanged: (bool value) {
                    setState(() {
                      ...
                      _formKey.currentState
                          ?.validate(); // Important to re-evaluate validation
                ...
                if (_isTbwKnown)
                  TextFormField(
                    ...
                    validator: (value) {
                      ...
                      return _validateDecimalField(value, 'total body water',
                          min: 1, max: 100); // Example range
                    },
                    decoration: const InputDecoration(
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      ...
                      return _validateDecimalField(value, 'age (decimal years)',
                          min: 0.01, max: 18); // Max 18y for this func
                    },
                    decoration: const InputDecoration(
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (_isTbwKnown) return null;
                      return _validateDecimalField(value, 'height (cm)',
                          min: 20, max: 200);
                    },
                    decoration: const InputDecoration(
                      labelText: 'Height (cm)',
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (_isTbwKnown) return null;
                      return _validateDecimalField(value, 'weight (kg)',
                          min: 1, max: 150);
                    },
                    decoration: const InputDecoration(
                      labelText: 'Weight (kg)',
                  ...
                  const SizedBox(height: 16),
                  Text('Biological Sex (for TBW calc):',
                  ...
                  children: <Widget>[
                        ...
                        style: OutlinedButton.styleFrom(
                          ...
                          side: BorderSide(
                              color: Theme.of(context)
                                  .colorScheme
                                  .primary), // Optional: style reset button
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        ...
                        label: const Text(
                            'Calculate'), // Kept it short as "Calculate"
                ...
                Padding(
                  // You can keep the outer padding for spacing from other elements
                  padding: const EdgeInsets.symmetric(
                      vertical: 8.0), // Adjust vertical padding as needed
                  child: Container(
                    padding: const EdgeInsets.all(
                        12.0), // Padding inside the colored box
                    decoration: BoxDecoration(
                        color: Colors
                            .amber[100], // A light amber/yellow for warning
                        borderRadius: BorderRadius.circular(
                            8.0), // Optional: rounded corners
                        border: Border.all(
                          // Optional: a thin border
                    ...
                    child: const Text(
                      ...
                      style: TextStyle(
                        fontSize: 12,
                        color: Colors
                            .black87, // Ensure text is readable on the background
                      ),
                    ),
                  ),
                ),
